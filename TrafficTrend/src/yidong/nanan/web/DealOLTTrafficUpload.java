...
import yidong.nan.file.OLTTrafficExcelDealer;

@SuppressWarnings(value={"serial","unused","deprecation","unchecked"})
public class DealOLTTrafficUpload extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			OLTTrafficExcelDealer oltTrafficExcel = new OLTTrafficExcelDealer();
			
			if(oltTrafficExcel.saveOLTTrafficInfo(filepath)){
